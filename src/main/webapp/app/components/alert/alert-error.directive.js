(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope, $translate) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('carpoolingCsid2016App.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-carpoolingCsid2016App-error');
                var entityKey = httpResponse.headers('X-carpoolingCsid2016App-params');
                if (errorHeader) {
                    ...
                    for (i = 0; i < httpResponse.data.fieldErrors.length; i++) {
                        ...
                        var fieldName = $translate.instant('carpoolingCsid2016App.' + fieldError.objectName + '.' + convertedField);
